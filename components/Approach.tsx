...
const Card = ({
  ...
  return (
    <div
      ...
      className="border border-black/[0.2] bg-dot-white/[0.2] group/canvas-card flex items-center justify-center dark:border-white/[0.2]  max-w-sm w-full mx-auto p-4 relative lg:h-[35rem] rounded-3xl"
    >
      ...
      <div className="relative z-20">
        ...
        <h2 className="dark:text-white text-sm opacity-0 group-hover/canvas-card:opacity-100 relative z-10 text-black mt-4  font-bold group-hover/canvas-card:text-white group-hover/canvas-card:-translate-y-2 transition duration-200 text-centr"
        style={{color: '#e4ecff'}}
        >
          {description}
        </h2>
